...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // WebSocket server is now initialized in server/websocket.ts
  // This prevents having two WebSocket servers on the same path
  // The WebSocket functionality previously here has been moved to server/websocket.ts
  console.log('WebSocket server is managed by server/websocket.ts');
